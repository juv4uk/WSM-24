...
WSM-24: south-polar azimuthal projection as a 24-hour dial. See PLAN.md for implementation phases; src/ is archival extraction (docs/provenance.md).

## Agent Guard (M0 — див. живий статус у плані, не тут)
...
Статус змінюється з часом — читайте статус-рядок самого файлу плану,
не покладайтесь на копію тут (востаннє звірено 2026-08-27: план був
TRIAL, кроки 1-4 DONE). Прочитайте перед write-heavy роботою.
